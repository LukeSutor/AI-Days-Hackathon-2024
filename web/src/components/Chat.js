    ...
    return (
        <>
            ...
            {!isOpen && (
                <button 
                    onClick={handleOpen} 
                    className="bg-black bg-opacity-50 border-2 border-white w-20 h-20 text-white p-2 rounded-full fixed bottom-4 right-4 transition-transform duration-300 hover:scale-105"
                >
